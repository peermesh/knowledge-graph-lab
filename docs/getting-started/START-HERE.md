...
./docs/operations/demos/start-demo.sh
```

Then open your browser to:
   - **Frontend Demo**: http://localhost:3000/demo-frontend.html (see `docs/operations/demos/`)
...
1. Run `./docs/operations/demos/start-demo.sh`
...
Docker Desktop is installed but had credential issues. The `docs/operations/demos/start-demo.sh` script runs everything locally without Docker, which is actually easier for development!
