...
`/Users/grig/work/peermesh/repo/knowledge-graph-lab-alpha/docs/team/module-assignments/ai-development/ai-module-holistic-review/deep-research/research-orchestration-cost-analysis/prompt.md`
...
2. **Once Fixed:** Re-run command:
   ...
   ~/.agents/scripts/perplexity-research.sh \
     /Users/grig/work/peermesh/repo/knowledge-graph-lab-alpha/docs/team/module-assignments/ai-development/ai-module-holistic-review/deep-research/research-orchestration-cost-analysis/prompt.md \
     /Users/grig/work/peermesh/repo/knowledge-graph-lab-alpha/docs/team/module-assignments/ai-development/ai-module-holistic-review/deep-research/research-orchestration-cost-analysis/responses/perplexity-cli.md
   ```
