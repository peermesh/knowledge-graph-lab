"""
Entity API endpoints for the Backend Architecture Module.

This module provides REST API endpoints for entity management including
CRUD operations, search, and knowledge graph operations.
"""
...
async def get_entity_relationships(
    ...
    direction: str = Query("both", regex="^(source|target|both)$", description="Relationship direction"),
    ...
    query = "SELECT * FROM entity_relationships WHERE "
    params = {}
    ...
    if direction == "source":
        ...
        query += "target_entity_id = :entity_id"
        params["entity_id"] = entity_id
    else:  # both
        query += "(source_entity_id = :entity_id OR target_entity_id = :entity_id)"
        params["entity_id"] = entity_id
